...
func TestNewArgument(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			got, err := buildArgument(&ArgumentContext{
				Method:    test.method,
				Overrides: overrides,
				Model:     model,
				Service:   service,
...
func TestNewPrimaryResourceArgument(t *testing.T) {
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			got := buildPrimaryResourceArgument(&ArgumentContext{
				Method:  test.method,
				Model:   model,
				Service: service,
				Field:   test.field,
...
func TestNewResourceReferenceSpec(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			got, err := resourceReferenceSpec(&ArgumentContext{
				Model:   model,
				Service: service,
				Field:   test.field,
			})
...
func TestNewResourceReferenceSpec_Error(t *testing.T) {
	...
	for _, test := range []struct {
		...
		t.Run(test.name, func(t *testing.T) {
			t.Parallel()
			_, err := resourceReferenceSpec(&ArgumentContext{
				Model:   &api.API{},
				Service: service,
				Field:   test.field,
			})
